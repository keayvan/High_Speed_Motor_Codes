...
if __name__ == '__main__':
    ...
    FILE_PATH = PROJECT_ROOT / "data" / "raw" / "TYTO" 
    FILE_PATTERN = 'ARC_P43_10002199_32187_correlation_steps_01_resample100ms.csv' # Pattern to find *all* motor test files for the general model
    ...
    FILE_PATTERN = 'ARC_P43_10002199_32187_correlation_steps_01_manual.csv'
    x=model_prop(FILE_PATH,FILE_PATTERN,motor_coeffs)
